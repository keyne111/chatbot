package cn.xiaofan.chatbot.domain.zsxq.service;
...
import cn.xiaofan.chatbot.domain.zsxq.model.req.AnswerReq;
import cn.xiaofan.chatbot.domain.zsxq.model.req.ReqData;
import cn.xiaofan.chatbot.domain.zsxq.model.res.AnswerRes;
...
public class ZsxqApi implements IZsxqApi {
    ...
    public boolean answer(String groupId, String cookie, String topicId, String text, boolean silenced) throws IOException {
        ...
        //告诉它从浏览器发起的
        post.addHeader("user-agent","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36 Edg/124.0.0.0");
